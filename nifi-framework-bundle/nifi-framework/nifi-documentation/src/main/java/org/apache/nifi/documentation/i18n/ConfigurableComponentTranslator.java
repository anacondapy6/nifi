...
public class ConfigurableComponentTranslator implements ComponentTranslationIntf {
    ...
    @Override
    public void translate(final Class<? extends ConfigurableComponent> componentClass, final File i18nDir,
        ...
        File file = new File(i18nDir, component.getClass().getCanonicalName() + ".json");
        Map<String, Object> container;

        try (InputStream stream = new FileInputStream(file)) {
            container = mapper.readValue(stream, TreeMap.class);
        }
