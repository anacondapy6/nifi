...
@Component({
    selector: 'management-process-group',
    standalone: true,
    imports: [
        AsyncPipe,
        ErrorBanner,
    ...
    templateUrl: './management-process-group.component.html',
    styleUrls: ['./management-process-group.component.scss']
})
export class ManagementProcessGroup extends CloseOnEscapeDialog {
